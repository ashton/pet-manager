...
let make = () => {
  ...
  <div className="card">
    <div className="card-content">
      ...
      <div className="field">
        <div className="control">
          <label className="label">{s({j|Espécie|j})}</label>
          <div className="field">
            <input id="sizeSmall" className="is-checkradio" type_="radio" name="size" value="Small" />
            <label htmlFor="sizeSmall">
              {s("Cachorro")}
            </label>

            <input id="sizeMedium" className="is-checkradio" type_="radio" name="size" value="Medium" />
      ...
      <div className="field">
        <div className="control">
          <label className="label">{s({j|Raça|j})}</label>
          <input className="input" type_="text" placeholder={j| raça do pet |j} />
        </div>
      </div>
      ...
      <div className="field">
        <div className="control">
          ...
          <div className="field">
            ...
            <input id="sizeLarge" className="is-checkradio" type_="radio" name="size" value="Large" />
